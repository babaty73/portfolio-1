    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-18 md:pt-32 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-10 items-center">
          ...
          >
            <div className="flex md:flex-col items-start sm:items-center gap-5 lg:gap-6">
              <div className="shrink-0 w-24 h-24 sm:w-36 sm:h-36 lg:w-48 lg:h-48 rounded-full overflow-hidden ring-1 ring-zinc-700 ring-offset-2 ring-offset-zinc-950">
                <img
                  src={profImage}
                  alt="Imran Idris"
              ...
              <div className="text-left sm:text-center ">
                <p
                  className="text-base sm:text-xl font-medium text-zinc-200"
                  style={{ fontFamily: "'Clash Display', sans-serif" }}
                >
                  Imran Idris
                </p>
                <p
                  className="mt-1 sm:mt-1.5 text-xs sm:text-sm text-zinc-500 tracking-wide"
          ...
          <div className="order-2 lg:order-1 w-full">
            ...
            <motion.h1
              ...
              className="font-semibold text-4xl sm:text-5xl md:text-5xl leading-tight tracking-tight"
              style={{ fontFamily: "'Clash Display', sans-serif" }}
            >
